...
public class NavActivity extends AppCompatActivity
    ...
    private Fragment getFragmentForMenuId(int id) {
        switch (id) {
            case R.id.nav_camera:
                return new NavFragmentImage();
            case R.id.nav_gallery:
                return new NavFragmentText();
            case R.id.nav_manage:
                return new NavSettingsFragment();
        }
        return null;
    }
    ...
    private void navigateToFragment(int id) {
        ...
        Fragment fragment = getFragmentForMenuId(id);
